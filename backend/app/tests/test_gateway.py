...
@pytest.mark.parametrize(
    "name, sensor_1_name, sensor_2_name, group_1_name, thing_1_name, location_name",
    [["Gateway1", "Sensor1", "Sensor2", "Group1", "Thing1", "Location1"],
     ["Gateway2", None, None, None, None, None]])
def test_get_gateway_exist(client: TestClient, session: Session,
                           ...
                           thing_1_name: str, location_name: str):
    # PRE
    if location_name:
    ...
    things = []
    if thing_1_name:
        things.append(create_thing(session, thing_1_name))
    create_gateway(session, name, sensors=sensors, things=things, groups=groups,
                   location_name=location_name)
    # TEST
